...
# Profile Features
ENABLE_BPP_BUILDER = True
ENABLE_COLOR_PALETTE_UNWRAPPER = True
ENABLE_IMPORT_UMAP_WITH_BOUNDS = True
ENABLE_PROP_BUILDER = True
ENABLE_MATERIAL_BUILDER = True
ENABLE_LANDSCAPE_MATERIAL_COMPILER = True
